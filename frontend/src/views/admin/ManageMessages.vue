                                    ...
                                    <tr v-for="(message, index) in messages" :key="index">
                                        ...
                                        <td class="gap-2">
                                            <div class="d-flex flex-column flex-sm-row gap-2">
                                                <button class="btn btn-warning" @click="showUpdateModal(message)">
                                                    Update
                                                </button>
                                                <button class="btn btn-danger" @click="deleteMessage(index)">
                                                    Delete
                                                </button>
                            ...
                            <div class="modal-body">
                                <form @submit.prevent="createMessage">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="name" v-model="newMessage.name" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="email" class="form-label">Email</label>
                                        <input type="email" class="form-control" id="email" v-model="newMessage.email" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="message" class="form-label">Message</label>
                                        <textarea class="form-control" id="message" v-model="newMessage.message" required></textarea>
                                    </div>
                            ...
                            <div class="modal-body">
                                <form @submit.prevent="updateMessage">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="update-name" v-model="currentMessage.name" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="update-email" class="form-label">Email</label>
                                        <input type="email" class="form-control" id="update-email" v-model="currentMessage.email" required>
                                    </div>
                                    <div class="mb-3">
                                        <label for="update-message" class="form-label">Message</label>
                                        <textarea class="form-control" id="update-message" v-model="currentMessage.message" required></textarea>
                                    </div>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <button class="btn btn-danger" @click="showReplyModalFlag = false"><i
                                        class="bi bi-x-lg"></i></button>
                            </div>
                            <div class="modal-body">
                                <form @submit.prevent="replyMessage">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="reply-name" v-model="replyMessageDetails.name" disabled>
                                    </div>
                                    <div class="mb-3">
                                        <label for="reply-email" class="form-label">Email</label>
                                        <input type="email" class="form-control" id="reply-email" v-model="replyMessageDetails.email" disabled>
                                    </div>
                                    <div class="mb-3">
                                        <label for="reply-original-message" class="form-label">Original Message</label>
                                        <textarea class="form-control" id="reply-original-message" v-model="replyMessageDetails.message" disabled></textarea>
                                    </div>
                                    <div class="mb-3">
...
export default {
    ...
    methods: {
        ...
        updateMessage() {
            const index = this.messages.findIndex(msg => msg.email === this.currentMessage.email);
            if (index !== -1) {
        ...
        replyMessage() {
            ...
            console.log(`Reply sent to ${this.replyMessageDetails.email}: ${this.replyMessageDetails.reply}`);
