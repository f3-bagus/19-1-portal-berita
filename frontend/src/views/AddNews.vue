    ...
    <ContributorLayout>
      <div class="container margin-top mb-5">
        ...
        <form @submit.prevent="submitPost">
          ...
          <div class="mb-3">
            <b><input type="text" class="form-control" placeholder="Enter an address" v-model="address" @blur="formatAddress" required></b>
          </div>
          <button type="submit" class="btn btn-danger" :disabled="!isFormValid" data-bs-toggle="modal" data-bs-target="#staticBackdrop">Submit News</button>
        </form>
      </div>
      ...
      <div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered">
                ...
                <div class="modal-body">
                    <p>Apakah data atau berita yang dimasukkan valid? Setelah ini berita tidak bisa diedit dan bersifat permanen.</p>
