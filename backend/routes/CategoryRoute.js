...
import { getCategories, getCategoriesById, createCategories, updateCategories, deleteCategories }
    from "../controllers/Category.js";
import { verifyToken, isAdmin } from "../middleware/Auth.js";
const router = express.Router();

router.get("/categories", verifyToken, isAdmin, getCategories);
router.get("/categories/:id", verifyToken, isAdmin, getCategoriesById);
