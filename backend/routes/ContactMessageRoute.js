...
import { sendMessage, getAllMessages, getMessagesByUserId, replyMessage, deleteMessage } from '../controllers/ContactMessage.js';
...
router.get('/admin/contact/:user_id', verifyToken, isAdmin, getMessagesByUserId);
